...
//
// Release 1.2 / 23 OCT 2008 (GP)
// -Fixed FLASH_Clear() to work properly with Bank 2 and Bank 3 addresses
//
// Release 1.1
...
{
																			 // first address in 1st page
                                       // containing <dest>
	 SI_SEGMENT_VARIABLE(dest_1_page_start, FLADDR, xdata);
	                                     // last address in 1st page
                                       // containing <dest>
	 SI_SEGMENT_VARIABLE(dest_1_page_end, FLADDR, xdata);
                                       // first address in 2nd page
                                       // containing <dest>
	 SI_SEGMENT_VARIABLE(dest_2_page_start, FLADDR, xdata);
	                                     // last address in 2nd page
                                       // containing <dest>
	 SI_SEGMENT_VARIABLE(dest_2_page_end, FLADDR, xdata);
	                                     // when crossing page boundary,
                                       // number of <src> bytes on 2nd page
	 SI_SEGMENT_VARIABLE(numbytes_remainder, unsigned, xdata);
	                                     // size of FLASH page to update
	 SI_SEGMENT_VARIABLE(FLASH_pagesize, unsigned, xdata);
	                                     // write address
	 SI_SEGMENT_VARIABLE(wptr, FLADDR, xdata);
	                                     // read address
   SI_SEGMENT_VARIABLE(rptr, FLADDR, xdata);
	 SI_SEGMENT_VARIABLE(length, unsigned, xdata);
...
void FLASH_Write (FLADDR dest, char *src, unsigned numbytes, bit SFLE)
{
   SI_SEGMENT_VARIABLE(i, FLADDR, xdata);
